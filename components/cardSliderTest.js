...
import styles from "./cardSliderTest.module.css";


export default function CardSliderTest() {
  return (
...
<div id="carouselExampleControls" className="carousel slide" data-bs-touch="false" data-bs-interval="false">
         ...
         */}
          ...
          <div className="tabbed-photo--area">    
                <div className="tab-content row">
                    <div className="photos col col-12 col-sm-6 d-md-block"><img className="img-fluid" alt="Room before" src="https://modsy-prod.imgix.net/mainsite-wp-content/2021/06/Toby-Before-1.jpg?auto=compress%2Cformat&amp;q=25"/></div>
                    <div className="photos col-12 col-sm-6 d-md-block"><img className="img-fluid" alt="Room after" src="https://modsy-prod.imgix.net/mainsite-wp-content/2021/06/Toby-After-1.jpg?auto=compress%2Cformat&amp;q=25"/></div>
                </div>
            </div>
  ...
  <button className="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
    <span className={`carousel-control-prev-icon ${styles.nextIcon}`} aria-hidden="true"></span>
