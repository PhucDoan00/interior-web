...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/create-payment").permitAll()
                ...
                .antMatchers("/api/v1/viewallbills/**").hasAnyRole("ADMIN", "STAFF")
                .antMatchers("/api/v1/accounts/**").hasRole("ADMIN")
                .antMatchers("/api/v1/feedback/**").hasRole("ADMIN")
                .antMatchers("/api/v1/designidea/createidea").hasRole("STAFF")
                .antMatchers("/api/v1/designidea/editidea/{id}").hasRole("STAFF")
                .antMatchers("/api/v1/designidea/deleteidea/{id}").hasRole("STAFF")
